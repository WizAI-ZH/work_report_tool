...
6. 不要输出“无”“暂无”“未提及”“根据内容推测”等占位解释，也不要把“无”作为编号条目（休息日除外：休息日明日计划只输出“休息”两个字，不编号、不加括号、不加省略号）。
7. 任何条目末尾严禁添加省略号“……”或“...”，也禁止添加装饰性标点收尾；条目按句意正常结束即可。
8. $restDayInstruction
...
- 今日进度只能写纯百分比，例如“65%”“100%”“20%”；严禁出现“预计XX%”“预计完成XX%”等带“预计”的写法。“预计”只允许出现在明日计划。
- 如果用户原文里今日进度写成了“预计XX%”，必须去掉“预计”二字，只保留纯百分比。
...
- 项目性工作的预计进度统一写“预计XX%”（例如“预计80%”“预计100%”），不要写“预计完成XX%”“预计XX%完成”等其他变体；预计进度应在今日进度基础上推进，不要倒退。
- 日常性或持续性工作不用加进度预计，括号内只写“预计完成的内容”，例如“技术支持（持续跟进并处理临时技术问题）”。
- 不允许把“预计继续”“持续跟进中”“继续推进”写在进度位置；这些只能写在预计完成内容里。
- 如果明日输入为空，且今日工作没有未完成项目、没有后续内容、也没有日常持续类事项，“2、明日工作计划：”标题下保持空白，严禁补“无”或“暂无”作为条目。
- 如果明日休息，只输出“休息”，不要编号和括号，也不要在“休息”后加省略号。

错误示例：
- 输入“横琴省赛研课对接（70%，目前聂总已跟研课方对接，预计6月初寄出最终版道具以正式启动研课）”，今日工作保持项目性模板；明日计划应继续保留该事项，例如“横琴省赛研课对接（预计80%，继续跟进研课对接并推进最终版道具寄出准备）”。
- 今日工作进度错误写法：“威智开发计划表制作（预计65%，继续讨论开发计划）”——今日进度严禁带“预计”。正确写法：“威智开发计划表制作（65%，继续讨论开发计划）”。只有明日计划才写“预计65%”。
...
标准参考样例（只学习格式、详略和明日计划筛选方式，严禁复制样例中的任务到最终结果）：

1、今日工作完成情况：
a. 交付进度表进度及预计完成日期填写（100%，已完成）
b. 项目配套资料工作分配及跟踪（100%，已完成）
c. 3D航天产品说明书编写（20%，已整理好相关素材资料，明天开始正式编写）
d. 威智历史项目规则编写（10%，正在修改线上对接表的规则内容，优化不同组别的具体分值和数量，明天继续补充剩下部分并建立规则文件）
e. 电教省赛总结文件填写（100%，已完成）
f. 威智视界测试（100%，已发现两个问题并修复其中一个问题，剩下测试由亚天和剑行明天进行完整流程和潜在BUG测试）
2、明日工作计划：
a. 3D航天产品说明书编写（预计40%，开始正式编写）
b. 威智历史项目规则编写（预计30%，继续补充剩下部分并建立规则文件）

样例说明：
- 今日 100% 且无后续的事项，没有进入明日计划。
- 今日 20%、10% 这类未完成事项，进入明日计划，并把预计进度往前推进。
- 今日 100% 但明确写了剩余测试交给别人，不属于本人明日计划，不要硬塞进明日计划。
- 今日事项可以写得具体，但明日计划要更短，只写明天要继续做什么。
